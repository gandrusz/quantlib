...
void CatBondTest::testEventSetForWholeYears() {
    BOOST_TEST_MESSAGE("Testing that cat events are split correctly for periods of whole years...");
...
void CatBondTest::testEventSetForIrregularPeriods() {
    BOOST_TEST_MESSAGE("Testing that cat events are split correctly for irregular periods...");
...
void CatBondTest::testEventSetForNoEvents () {
    BOOST_TEST_MESSAGE("Testing that cat events are split correctly when there are no simulated events...");
...
void CatBondTest::testBetaRisk() {
    BOOST_TEST_MESSAGE("Testing that BetaRisk gives correct terminal distribution...");
...
void CatBondTest::testRiskFreeAgainstFloatingRateBond() {
    BOOST_MESSAGE("Testing floating-rate catBond against risk-free QuantLib floating-rate bond...");
...
void CatBondTest::testCatBondInDoomScenario() {
    BOOST_MESSAGE("Testing floating-rate catBond in a Doom scenario (certain default)...");
...
void CatBondTest::testCatBondWithDoomOnceInTenYears() {
    BOOST_MESSAGE("Testing floating-rate catBond in a Doom once in 10 years scenario...");
    ...
    Real price = catBond.cleanPrice();
    Real yield = catBond.yield(ActualActual(ActualActual::ISMA), Compounding::Simple, Frequency::Annual);
    Real lossProbability = catBond.lossProbability();
    Real exhaustionProbability = catBond.exhaustionProbability();
    Real expectedLoss = catBond.expectedLoss();
    ...
    Real riskFreeYield = catBond.yield(ActualActual(ActualActual::ISMA), Compounding::Simple, Frequency::Annual);
...
void CatBondTest::testCatBondWithDoomOnceInTenYearsProportional() {
    BOOST_MESSAGE("Testing floating-rate catBond in a Doom once in 10 years scenario with proportional notional reduction...");
...
void CatBondTest::testCatBondWithGeneratedEventsProportional() {
    BOOST_MESSAGE("Testing floating-rate catBond in a generated scenario with proportional notional reduction...");
